import TranslateWrapper, {
  TranslateWrapperInfo,
} from "@/components/hud-ui/translatewrapper";
...
export const CARD_TEST_001: MinimalistItemSocialCardProps = {
  image: {
...
export function MinimalistItemSocialCardPreviewDisplay() {
  return <MinimalistItemSocialCard card={CARD_TEST_001} />;
}

export const MinimalistItemSocialCardInfo: InspirationComponentResource = {
  type: "components",
  title: "Minimalist Item/Social Card",
  display: <MinimalistItemSocialCardPreviewDisplay />,
  description:
    "A minimalist item/social card that displays a preview image, insights, credit, title, description, details, and tags.",
  category: ["minimalist", "card", "social"],
  createdAt: "2024-04-17",
  credits: [
    {
      name: "Vinne",
      role: "Artist",
      info: "Illustrator of the artwork I used in the card. Check out their Instagram, I love the perspectives and personality they capture in their work.",
      link: "https://www.instagram.com/vinne.art",
    },
    {
      name: "Raphael Salaja",
      role: "Designer",
      info: "Designer of the card itself. Check out their Twitter, they have a lot of cool minimalist design work.",
      link: "https://x.com/raphaelsalaja/status/1772210566297199098",
    },
  ],
  dependencies: [NextJS, RadixUIIcons, FramerMotion, Clsx, TailwindMerge],
  code: `export function MinimalistItemSocialCard({
  card,
}: {
  ...
  props: [
    {
      name: "MinimalistItemSocialCardProps",
      description: "The props for the MinimalistItemSocialCard component.",
      code: `type MinimalistItemSocialCardProps = {
  image: {
    src: string;
    alt: string;
  };
  ...
  componentDependencies: [TranslateWrapperInfo],
  utilDependencies: [
    {
      name: "formatNumber",
      description: "Formats a number into a human-readable string.",
      category: ["utility", "number", "format"],
      code: `function formatNumber(num: number): string {
  if (num >= 1_000_000_000) {
    ...
    },
    {
      ...
      category: ["utility", "string", "format"],
      code: `/**
