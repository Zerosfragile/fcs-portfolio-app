    ...
    <div className="grid place-items-center w-full h-full">
      <div className="w-full p-4">
        ...
        <div className="text-left my-4 text-sm font-[arthemys] text-muted-foreground flex flex-col gap-4">
          <p>
            Hope you are doing well. I know we haven't talked much this year,
            but I'm always here if you need anything. I wish you success in your
            studies and with your friends. Remember that the process of learning
            is more important than a grades.
          </p>
