    ...
    <div className="grid place-items-center w-full h-full">
      <div className="w-full p-4 max-w-sm">
        ...
        <div className="text-left my-4 text-sm font-[arthemys] text-muted-foreground flex flex-col gap-4">
          <p>
            In 2023, I&apos;ve spent a lot of time thinking about time. Time in
            the past, time in the future, and time in the present. I&apos;ve
            noticed your attempts to reach out and communicate with me, and for
            my part in not responding as I should, I apologize.
          </p>
          <p>
            ...
            something I&apos;m afraid of disappointing, as I known I&apos;m not
            yet there.
          </p>
          <p>
            As 2024 approaches, I hope to push myself harder, to create more, to
            experience more, and to achieve excellence which I&apos;ll be able
            to share with you. Until, then I hope you&apos;ll continue to
            support me as I keep my head down and work.
          </p>
