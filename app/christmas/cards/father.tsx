    ...
    <div className="grid place-items-center w-full h-full">
      <div className="w-full p-4 max-w-sm">
        ...
        <div className="text-left my-4 text-sm font-[arthemys] text-muted-foreground flex flex-col gap-4">
          <p>
            This year, more than ever, I&apos;d like to thank you for your
            continued support and belief in me. I&apos;m always disappointed in
            myself for not being able to express my gratitude and being unable
            to support you in the same way you&apos;ve supported me.
          </p>
          <p>
            I hope that during 2024 year I can work towards making up for that.
            I&apos;ve always been inspired by your work ethic, ambition and
            patience. Looking ahead to the new year, I am filled with
            determination.
          </p>
          <p>
